...
import { sortEvents } from '../../shared/event-sort';
import { createEventListFilters } from '../../shared/event-list-filters';
...
import { FilterAllComponent } from '../../shared/filter-all/filter-all.component';
...
export class FavoritesPage implements OnInit, AfterViewInit, OnDestroy, ViewWillEnter {
   ...
   * shared/event-list-filters.ts's own doc comment). "upcomingOnly" matches
